function [turnInterval] = findTurns(gyroVertical, FS, thresholdDegrees, thresholdLPfiltering, thresholdPeakDS,thresholdCrossingDS,thresholdIntraTurnS,thresholdTurnDurationLowS, thresholdTurnDurationHighS )
...
for i=1:size(totalTurns,1)
    degrees(i)=TurnDeg(gyroVertical(totalTurns(i,1):totalTurns(i,2)),FS);
